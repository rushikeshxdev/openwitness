...
export function MapActivityStrip({
  ...
  return (
    <section
      className={cn(
        "rounded-2xl border border-white/12 bg-[#121214]/90 p-3 backdrop-blur-md sm:p-4",
        className
      )}
      ...
      <div className="relative">
        {canLeft && (
          <button
            type="button"
            onClick={() => scroll("left")}
            className="absolute -left-1 top-1/2 z-10 hidden -translate-y-1/2 rounded-full border border-white/15 bg-[#121214] p-1.5 text-zinc-300 shadow-lg sm:flex"
        ...
        {canRight && (
          <button
            ...
            className="absolute -right-1 top-1/2 z-10 hidden -translate-y-1/2 rounded-full border border-white/15 bg-[#121214] p-1.5 text-zinc-300 shadow-lg sm:flex"
            ...
            events.map((event) => {
              ...
              return (
                <button
                  ...
                  className={cn(
                    "w-[220px] shrink-0 overflow-hidden rounded-xl border text-left transition-colors",
                    selected
